...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='diego', password='12345')
        self.usuario_b = User.objects.create(username='andres', password='12345')
        self.usuario_c = User.objects.create(username='javier', password='12345')
    ...
    def prueba_dos_usuarios(self):
        ...
        self.assertEqual(solo_dos.count(), 2)